...
export class Item extends React.Component {
    ...
    render() {
        ...
        const {picture, title, price, condition, sold_quantity, description} = this.state.item;
        let pictureEdit = picture.replace("-I.jpg", "-O.jpg");
        let conditionEdit = condition == "new" ? 'Nuevo' : condition;
        return (
